...
func (c *orderServiceClient) RealAllOrders(ctx context.Context, in *RealAllOrdersRequest, opts ...grpc.CallOption) (*RealAllOrdersResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RealAllOrdersResponse)
	err := c.cc.Invoke(ctx, OrderService_RealAllOrders_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _OrderService_RealAllOrders_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RealAllOrdersRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(OrderServiceServer).RealAllOrders(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: OrderService_RealAllOrders_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServiceServer).RealAllOrders(ctx, req.(*RealAllOrdersRequest))
	}
	return interceptor(ctx, in, info, handler)
}
